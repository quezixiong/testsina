...
if __name__ == '__main__':
    ...
    #doctest.testmod()
    APP_KEY = '2174328400'
    APP_SECRET = '7ce45d181d3bbc0536c5e3d65a9a85ed'
    access_token = '2.00ImBkCGuIQJ4Cd245aa518bwQL1kC'
    expires = 1393739173.5
    c = APIClient(SinaWeiboMixin, APP_KEY, APP_SECRET, 'http://www.liaoxuefeng.com/auth/callback', access_token, expires)
    # print c.get_openid(access_token)
    r = c.statuses.home_timeline.get(count=10)
    print r
    # r = c.statuses.update.post(status=u'测试http post')
    # print r
    r = c.statuses.upload.post(status=u"测试图片l", pic=open("/Users/harley/workspace/media/wechat/pictureMaterial/zixong.png", 'rb'))
    print r
